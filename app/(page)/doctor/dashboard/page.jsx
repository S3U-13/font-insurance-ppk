...
import SplineArea from "./chart_components/spline-area"; // ✅ ปรับชื่อให้ถูก

export default function page() {
  return (
    <div className="space-y-4">
      <h1 className="mt-4 text-center text-xl font-bold">CHART</h1>
      <div className="bg-[#d8efef] dark:bg-[#0e0e11] dark:border dark:border-divider w-full h-195 rounded-lg p-4 grid grid-cols-12 gap-4">
        <div className="col-span-4 grid grid-cols-2 gap-4 h-75">
          <p className="col-span-2">TOTAL</p>
          <Card className="h-35 bg-[#edf7f7] dark:border dark:border-divider dark:bg-[#18181b]">
        ...
        <div className="col-span-8 ">
          ...
          <Card className="bg-[#edf7f7]  rounded-xl h-74 mt-4 dark:border dark:border-divider dark:bg-[#18181b]">
            <CardBody>
              <ColumnChart />
            </CardBody>
          </Card>
        ...
        <div className="col-span-4">
          <Card className="bg-[#edf7f7]  rounded-xl h-96 dark:border dark:border-divider dark:bg-[#18181b]">
