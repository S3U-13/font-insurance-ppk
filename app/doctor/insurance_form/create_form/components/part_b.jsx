...
export default function page({
  ...
  // รับค่า date time ของ firstSeenDate and injuryDate
  firstSeen,
  injuryDate,
}) {
  const patient_name = patData?.pat
  ...
  return (
    <div className="space-y-6 px-40 pb-6">
      ...
      <div className="border border-[#b0dddf] dark:border-divider  bg-[#d8efef] dark:bg-[#18181B] rounded-xl p-4 rounded-xl ">
      ...
      <div className="grid grid-cols-8 gap-2 items-center">
        <div className="col-span-4 border border-[#b0dddf] dark:border-divider  bg-[#d8efef] dark:bg-[#18181B]  p-4 space-y-2 rounded-xl h-full">
        ...
        <div className="col-span-4 border border-[#b0dddf] dark:border-divider  bg-[#d8efef] dark:bg-[#18181B] p-4 space-y-2 rounded-xl grid grid-cols-3 gap-2">
      ...
      <div className="grid grid-cols-8 gap-2 items-center border border-[#b0dddf] dark:border-divider  bg-[#d8efef] dark:bg-[#18181B] rounded-xl  p-4 space-y-2">
          ...
          <Table
            ...
            onSelectionChange={(keys) => {
              ...
              const selected =
                keys === "all"
                  ? data
                  : data.filter((d) => keys.has(String(d.refId)));
            ...
            .map((item, index) => (
              ...
              >
                ...
                <Input
                  ...
                  value={formatThaiDateTime(item?.starttime ?? "")}
                />
              </div>
            ))
        ) : (
                    ...
                    >
                      {(field) => (
                        <DatePicker
                          ...
                          variant="bordered"
                          onChange={(d) =>
                            field.handleChange(d?.toString() ?? null)
                          }
                        />
                      )}
                    </form.Field>
