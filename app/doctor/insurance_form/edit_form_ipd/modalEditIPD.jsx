...
export default function ModalEditIPD({
  isOpen,
  onClose,
  claimData,
  selectID,
  ...
  const {
    ...
    firstSeen,
    injuryDate,
  } = useHook({ onClose, isOpen, claimData, selectID, setClaimData, claimId });
            ...
            >
              <ModalHeader className="flex flex-col gap-1 text-center ">
                ...
                {activeStep === "2" && (
                  <>
                    <h1>
                      <strong>Discharge Notification Form (เเก้ไข)</strong>
                    </h1>
                    <p>
                      <strong>Hospital Name</strong> พระปกเกล้า จันทบุรี
                    </p>
                  ...
                  {CanManageOPD === "N" && (
                    <Tab key="2" title="PART B" disabled>
                      <PartB
                        ...
                        diagValueByClaimData={diagValueByClaimData}
                        getRowKey={getRowKey}
                        dates={dates}
