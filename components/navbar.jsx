...
export default function Navbar() {
  ...
  return (
    <div className="h-18 w-full p-6 border border-divider rounded-lg flex items-center justify-between px-6">
      <Button size="md" variant="solid" onPress={() => setOpenDrawer(true)} isIconOnly>
        {openDrawer === false && (
          <svg
